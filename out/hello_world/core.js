...
*/
hello_world.core.anagrams = (function anagrams(word,wordlist){return cljs.core.filter.call(null,(function (p1__7803_SHARP_){return cljs.core._EQ_.call(null,cljs.core.sort.call(null,p1__7803_SHARP_),cljs.core.sort.call(null,word));
}),wordlist);
});
...
return dommy.core.set_text_BANG_.call(null,document.getElementById("result"),cljs.core.apply.call(null,cljs.core.str,cljs.core.take.call(null,cljs.core.deref.call(null,hello_world.core.hint_count),cljs.core.first.call(null,cljs.core.deref.call(null,hello_world.core.results)))));
});
