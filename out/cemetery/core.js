...
cemetery.core.show_details_QMARK_ = cljs.core.atom.call(null,false);
/**
* Pass state to UI for update
*/
cemetery.core.ui_update = (function ui_update(){return cemetery.ui.update.call(null,cljs.core.deref.call(null,cemetery.core.records),cljs.core.deref.call(null,cemetery.core.record_details),cljs.core.deref.call(null,cemetery.core.start_index),cemetery.core.MAX_RECORDS,cljs.core.deref.call(null,cemetery.core.show_details_QMARK_),cemetery.core.on_select,cemetery.core.on_close);
});
/**
...
return (function (p1__5425_SHARP_){return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"area1","area1",-316994623).cljs$core$IFn$_invoke$arity$1(details),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__5425_SHARP_));
});})(text,details,area))
...
cemetery.core.on_select = (function on_select(e){var id = ((cljs.core._EQ_.call(null,"LI",e.target.tagName))?e.target.id:e.target.parentElement.id);cljs.core.reset_BANG_.call(null,cemetery.core.record_id,id);
cljs.core.reset_BANG_.call(null,cemetery.core.show_details_QMARK_,true);
cemetery.core.fetch_details.call(null);
return e.preventDefault();
});
cemetery.core.on_close = (function on_close(e){cljs.core.reset_BANG_.call(null,cemetery.core.show_details_QMARK_,false);
